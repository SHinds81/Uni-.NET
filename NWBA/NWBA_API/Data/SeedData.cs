        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            context.Transactions.AddRange(
                new Transaction
                {
                    ...
                    TransactionTime = DateTime.ParseExact("19/12/2019 08:00:00 PM", format, null)
                },
                new Transaction
                {
                    Type = TransactionType.Deposit,
                    ...
                    Amount = 500,
                    Comment = openingBalance,
                    TransactionTime = DateTime.ParseExact("19/12/2019 08:30:00 PM", format, null)
                },
                new Transaction
                {
                    Type = TransactionType.Deposit,
                    ...
                    Amount = 500.95m,
                    Comment = openingBalance,
                    TransactionTime = DateTime.ParseExact("19/12/2019 09:00:00 PM", format, null)
                },
                new Transaction
                {
                    Type = TransactionType.Deposit,
                    ...
                    TransactionTime = DateTime.ParseExact("19/12/2019 10:00:00 PM", format, null)
                });
